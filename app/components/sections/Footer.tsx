          ...
          <div className='flex gap-[20px]'>
            <a href="https://x.com" className='group'>
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle className="group-hover:fill-[var(--color-accent)] transition-colors duration-300" cx="15" cy="15" r="15" fill="white"/>
                <path
            ...
            <a href="https://facebook.com" className='group'>
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path className="group-hover:fill-[var(--color-accent)] transition-colors duration-300"
        ...
        <div className='flex justify-between'>
          ...
          <div className='py-[58px] px-[40px] bg-[#292A32] rounded-[14px]'>
            <form action="" className='flex gap-[20px]' onSubmit={handleSubmit(onSubmit)}>
              <input {...register('email')} type="text" className='px-[35px] py-[22px] outline-none border-white border-1 rounded-[14px] placeholder:text-white' placeholder='Email'/>
